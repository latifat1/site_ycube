...
Veuillez contacter le client pour confirmer le rendez-vous.`}}e.s(["getApplicationConfirmationTemplate",()=>o,"getAppointmentConfirmationTemplate",()=>r,"getAppointmentNotificationTemplate",()=>a,"getAppointmentStatusTemplate",()=>s,"getContactConfirmationTemplate",()=>n])},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},85964,e=>{"use strict";var t=e.i(86795),r=e.i(91010),n=e.i(70349),o=e.i(90128),s=e.i(39414),a=e.i(4489),i=e.i(18047),l=e.i(8472),d=e.i(86937),p=e.i(91618),u=e.i(16521),c=e.i(89493),m=e.i(69761),x=e.i(56510),g=e.i(11587),f=e.i(93695);e.i(29720);var h=e.i(24633),v=e.i(28549),y=e.i(16815),b=e.i(44716),w=e.i(54799);async function R(e){let t,r,{id:n,status:o,date:s,time:a}=await e.json();if(!n||!o)return v.NextResponse.json({error:"Missing id or status"},{status:400});let i={status:o};s&&(i.date=new Date(s)),a&&(i.time=a),"a_replanifier"===o?(t=w.default.randomBytes(24).toString("hex"),r=new Date,i.rescheduleToken=t,i.rescheduleTokenCreatedAt=r):(i.rescheduleToken=null,i.rescheduleTokenCreatedAt=null);let l={id:n,name:"Client",service:"Service",date:new Date(s||new Date),time:a||"",status:o,...i};if("confirme"===o||"a_replanifier"===o||"annule"===o){let e=(0,b.getAppointmentStatusTemplate)({name:l.name,service:l.service,status:o,date:l.date.toISOString(),time:l.time}),t="Mise à jour de votre rendez-vous";"confirme"===o?t="Votre rendez-vous est confirmé !":"a_replanifier"===o?t="Replanification de votre rendez-vous":"annule"===o&&(t="Votre rendez-vous a été annulé"),await (0,y.sendMail)({to:l.email,subject:t,text:e.text,html:e.html})}return v.NextResponse.json(l)}e.s(["POST",()=>R],90932);var E=e.i(90932);let C=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api.disabled/appointment-status/route",pathname:"/api.disabled/appointment-status",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/site_ycube/projet-interne/y3-audit-conseils/app/api.disabled/appointment-status/route.ts",nextConfigOutput:"export",userland:E}),{workAsyncStorage:A,workUnitAsyncStorage:$,serverHooks:N}=C;function z(){return(0,n.patchFetch)({workAsyncStorage:A,workUnitAsyncStorage:$})}async function k(e,t,n){C.isDev&&(0,o.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let v="/api.disabled/appointment-status/route";v=v.replace(/\/index$/,"")||"/";let y=await C.prepare(e,t,{srcPage:v,multiZoneDraftMode:!1});if(!y)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:b,params:w,nextConfig:R,parsedUrl:E,isDraftMode:A,prerenderManifest:$,routerServerContext:N,isOnDemandRevalidate:z,revalidateOnlyGenerated:k,resolvedPathname:D,clientReferenceManifest:T,serverActionsManifest:S}=y,_=(0,i.normalizeAppPath)(v),j=!!($.dynamicRoutes[_]||$.routes[D]),q=async()=>((null==N?void 0:N.render404)?await N.render404(e,t,E,!1):t.end("This page could not be found"),null);if(j&&!A){let e=!!$.routes[D],t=$.dynamicRoutes[_];if(t&&!1===t.fallback&&!e){if(R.experimental.adapterPath)return await q();throw new f.NoFallbackError}}let P=null;!j||C.isDev||A||(P="/index"===(P=D)?"/":P);let O=!0===C.isDev||!j,H=j&&!O;S&&T&&(0,a.setManifestsSingleton)({page:v,clientReferenceManifest:T,serverActionsManifest:S});let M=e.method||"GET",I=(0,s.getTracer)(),L=I.getActiveScopeSpan(),U={params:w,prerenderManifest:$,renderOpts:{experimental:{authInterrupts:!!R.experimental.authInterrupts},cacheComponents:!!R.cacheComponents,supportsDynamicResponse:O,incrementalCache:(0,o.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:R.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,o)=>C.onRequestError(e,t,n,o,N)},sharedContext:{buildId:b}},F=new l.NodeNextRequest(e),Y=new l.NodeNextResponse(t),B=d.NextRequestAdapter.fromNodeNextRequest(F,(0,d.signalFromNodeResponse)(t));try{let a=async e=>C.handle(B,U).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=I.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${M} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${v}`)}),i=!!(0,o.getRequestMeta)(e,"minimalMode"),l=async o=>{var s,l;let d=async({previousCacheEntry:r})=>{try{if(!i&&z&&k&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await a(o);e.fetchMetrics=U.renderOpts.fetchMetrics;let l=U.renderOpts.pendingWaitUntil;l&&n.waitUntil&&(n.waitUntil(l),l=void 0);let d=U.renderOpts.collectedTags;if(!j)return await (0,c.sendResponse)(F,Y,s,U.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(s.headers);d&&(t[g.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==U.renderOpts.collectedRevalidate&&!(U.renderOpts.collectedRevalidate>=g.INFINITE_CACHE)&&U.renderOpts.collectedRevalidate,n=void 0===U.renderOpts.collectedExpire||U.renderOpts.collectedExpire>=g.INFINITE_CACHE?void 0:U.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==r?void 0:r.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:v,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:H,isOnDemandRevalidate:z})},!1,N),t}},p=await C.handleResponse({req:e,nextConfig:R,cacheKey:P,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:$,isRoutePPREnabled:!1,isOnDemandRevalidate:z,revalidateOnlyGenerated:k,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:i});if(!j)return null;if((null==p||null==(s=p.value)?void 0:s.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==p||null==(l=p.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});i||t.setHeader("x-nextjs-cache",z?"REVALIDATED":p.isMiss?"MISS":p.isStale?"STALE":"HIT"),A&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let f=(0,m.fromNodeOutgoingHttpHeaders)(p.value.headers);return i&&j||f.delete(g.NEXT_CACHE_TAGS_HEADER),!p.cacheControl||t.getHeader("Cache-Control")||f.get("Cache-Control")||f.set("Cache-Control",(0,x.getCacheControlHeader)(p.cacheControl)),await (0,c.sendResponse)(F,Y,new Response(p.value.body,{headers:f,status:p.value.status||200})),null};L?await l(L):await I.withPropagatedContext(e.headers,()=>I.trace(p.BaseServerSpan.handleRequest,{spanName:`${M} ${v}`,kind:s.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},l))}catch(t){if(t instanceof f.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:_,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:H,isOnDemandRevalidate:z})},!1,N),j)throw t;return await (0,c.sendResponse)(F,Y,new Response(null,{status:500})),null}}e.s(["handler",()=>k,"patchFetch",()=>z,"routeModule",()=>C,"serverHooks",()=>N,"workAsyncStorage",()=>A,"workUnitAsyncStorage",()=>$],85964)},60815,e=>{e.v(t=>Promise.all(["server/chunks/[externals]_fs_promises_0bfe4114._.js"].map(t=>e.l(t))).then(()=>t(24868)))},89793,e=>{e.v(t=>Promise.all(["server/chunks/[externals]_path_e30b8067._.js"].map(t=>e.l(t))).then(()=>t(14747)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__bc9f9d3c._.js.map
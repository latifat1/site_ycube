...
import { 
  TrendingUp, ArrowRight, Clock, Eye, Download, 
  BookOpen, FileText, Newspaper, CheckCircle
} from "lucide-react"
...
export default function ActualitesPage() {
  ...
  return (
    <>
      <MainSlider slides={actualitesSlides} />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-12 max-w-3xl mx-auto">
              Découvrez nos analyses exclusives, rapports d'experts et actualités sur l'évolution 
